...
window.BRANDS = [
  {
    ...
    models: [
      { model: "Cannon", configs: ["dually","super single"], sizes: ["22x12","24x14","26x16","28x16"], finishes: ["Polished","Brushed","Black"], img: "assets/wheel-angle-1.png" },
      { model: "Combat", configs: ["dually","super single"], sizes: ["22x8.25","24x8.25","24x12","24x14"], finishes: ["Polished","Brushed","Black"], img: "assets/wheel-angle-2.png" },
      { model: "Flight", configs: ["dually","super single"], sizes: ["22x8.25","24x8.25","24x14"], finishes: ["Polished","Brushed","Black"], img: "assets/wheel-angle-3.png" },
      { model: "Reaper", configs: ["dually","super single"], sizes: ["22x8.25","24x8.25","24x14"], finishes: ["Polished","Brushed","Black"], img: "assets/wheel-face-2.png" },
      { model: "Major", configs: ["dually","super single"], sizes: ["22x8.25","24x8.25","24x12"], finishes: ["Polished","Brushed","Black"], img: "assets/wheel-face-1.png" },
      { model: "Centerfire", configs: ["single","dually"], sizes: ["22x8.25","24x8.25","24x14"], finishes: ["Polished","Brushed","Black"] },
      { model: "Ballistic", configs: ["single","dually"], sizes: ["22x12","24x14","24x8.25"], finishes: ["Polished","Brushed","Black"] },
      { model: "Silencer", configs: ["single","dually"], sizes: ["22x12","24x14","24x8.25"], finishes: ["Polished","Brushed","Black"] },
      { model: "Tomahawk", configs: ["single","dually"], sizes: ["22x12","24x14","24x8.25"], finishes: ["Polished","Brushed","Black"] },
      { model: "Crater", configs: ["single","dually"], sizes: ["22x12","24x14","24x8.25"], finishes: ["Polished","Brushed","Black"] },
      { model: "Dime", configs: ["single","dually"], sizes: ["22x8.25","24x8.25","24x14"], finishes: ["Polished","Brushed","Black"] },
      { model: "Empire", configs: ["single","dually"], sizes: ["22x12","24x14","24x8.25"], finishes: ["Polished","Brushed","Black"] },
      { model: "Slayer", configs: ["dually"], sizes: ["22x8.25","24x8.25"], finishes: ["Polished","Brushed","Black"] },
      { model: "Chamber", configs: ["single"], sizes: ["20x12","22x12","24x14"], finishes: ["Polished","Brushed","Black"] },
      { model: "Recoil", configs: ["single"], sizes: ["22x12","24x12","24x14"], finishes: ["Polished","Brushed","Black"] },
      { model: "Rumble", configs: ["single"], sizes: ["22x12","24x12","24x14"], finishes: ["Polished","Brushed","Black"] },
      { model: "Psycho", configs: ["single","dually"], sizes: ["22x12","24x14","24x8.25"], finishes: ["Polished","Brushed","Black"] },
      { model: "Vanquish", configs: ["single","dually"], sizes: ["22x12","24x14","24x8.25"], finishes: ["Polished","Brushed","Black"] }
    ]
  },
  {
